  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "src/engine/backtestExtended.ts",
      ...
      thresholds: {
        ...
        "src/engine/backtestExtended.ts": { lines: 100, functions: 100, branches: 90 },
        "src/engine/backtest.ts":         { lines: 100, functions: 100, branches: 80 },
        "src/engine/random.ts":           { lines: 100 },
      },
    },
  },
});
