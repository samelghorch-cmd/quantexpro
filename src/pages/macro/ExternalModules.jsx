...
const EXT = {
  ...
  shipTracker: { title: "Ship Tracker", providers: ["MarineTraffic", "Spire AIS"], description: "Suivi du trafic maritime (AIS) pour l'analyse des flux de matières premières. Nécessite un flux AIS." },
  ...
  liveTv: { title: "Live TV", providers: ["Bloomberg TV", "CNBC", "YouTube Live"], description: "Flux vidéo / actualité financière en direct. Nécessite une source de streaming vidéo externe." },
