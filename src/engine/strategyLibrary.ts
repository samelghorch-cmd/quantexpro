...
// Contexte tel que consommé par les stratégies : accès mixte statique (ctx.close[i]) ET
// dynamique (familles paramétrées : ctx[type][période], composites ctx.bb["20_2"].lo[i]).
// La shape précise vit dans context.ts (TradingContext) mais n'est pas réutilisable telle
// quelle ici — l'indexation dynamique impose un contexte indexable.
type StrategyCtx = Record<string, any>;
type StratSignal = { long: boolean; short: boolean };
type StratEval = (ctx: StrategyCtx, i: number) => StratSignal;
interface StrategyDef { id: number; name: string; cat: string; eval: StratEval; }
...
export const STRAT_FAMILIES = {
  ...
  maCross: (type: string, fast: number, slow: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === RSI reversion ===
  rsiRev: (period: number, low: number, high: number) => (ctx: StrategyCtx, i: number) => {
  ...
  bbBreakout: (n: number, mult: number) => (ctx: StrategyCtx, i: number) => {
  ...
  bbBounce: (n: number, mult: number) => (ctx: StrategyCtx, i: number) => {
    const bb = ctx.bb[`${n}_${mult}`];
  ...
  // === Keltner ===
  keltBreakout: (n: number, mult: number) => (ctx: StrategyCtx, i: number) => {
  ...
  keltBounce: (n: number, mult: number) => (ctx: StrategyCtx, i: number) => {
    const k = ctx.kelt[`${n}_${mult}`];
  ...
  // === Donchian breakout ===
  donchianBreak: (n: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === Williams %R ===
  wprRev: (period: number, low: number, high: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === CCI ===
  cciRev: (period: number, level: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === Stochastic ===
  stochRev: (period: number, dp: number, low: number, high: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === MACD signal cross ===
  macdCross: (f: number, s: number, sig: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === SuperTrend ===
  superTrend: (n: number, mult: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === ADX + trend ===
  adxTrend: (adxThreshold: number, emaPeriod: number) => (ctx: StrategyCtx, i: number) => {
  ...
  squeeze: (n: number, bbMult: number, kcMult: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === Z-Score reversion ===
  zscoreRev: (n: number, sigma: number) => (ctx: StrategyCtx, i: number) => {
    const z = ctx.z[n];
    if (!z || isNaN(z[i]) || isNaN(z[i - 1])) return { long: false, short: false };
    return { long: z[i - 1] < -sigma && z[i] >= -sigma, short: z[i - 1] > sigma && z[i] <= sigma };
  },
  // === Hurst + EMA ===
  hurstTrend: (_hurstLen: number, threshold: number, emaPeriod: number) => (ctx: StrategyCtx, i: number) => {
  ...
  structBreak: (len: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === Stop run + reclaim ===
  stopRun: (len: number) => (ctx: StrategyCtx, i: number) => {
  ...
  engulfing: () => (ctx: StrategyCtx, i: number) => {
  ...
  // === VWAP break ===
  vwapBreak: () => (ctx: StrategyCtx, i: number) => {
  ...
  orb: (len: number, sessionStartBar: number) => (ctx: StrategyCtx, i: number) => {
    const dayLen = 78;
  ...
  nrN: (n: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === MFI ===
  mfiRev: (period: number, low: number, high: number) => (ctx: StrategyCtx, i: number) => {
  ...
  vpinSpike: () => (ctx: StrategyCtx, i: number) => {
  ...
  // === Session bias ===
  sessionBias: (hourStart: number, hourEnd: number) => (ctx: StrategyCtx, i: number) => {
  ...
  // === Ichimoku ===
  ichimokuTK: (t: number, k: number) => (ctx: StrategyCtx, i: number) => {
...
export function buildStrategyLibrary() {
  const lib: StrategyDef[] = [];
  const add = (id: number, name: string, cat: string, fam: StratEval) => lib.push({ id, name, cat, eval: fam });
  ...
  add(5,  "Triple EMA Stack",        "a", (ctx: StrategyCtx, i: number) => {
  ...
  add(9,  "HMA(20) Slope",           "a", (ctx: StrategyCtx, i: number) => {
    const h = ctx.hma[20];
  ...
  add(17, "RSI + BB Lower Bounce",   "b", (ctx: StrategyCtx, i: number) => {
  ...
  add(18, "StochRSI 0.2/0.8",        "b", (ctx: StrategyCtx, i: number) => {
  ...
  add(24, "VWAP Mean Reversion",     "b", (ctx: StrategyCtx, i: number) => {
  ...
  add(25, "RSI 50 Reversion",        "b", (ctx: StrategyCtx, i: number) => {
    const r = ctx.rsi[14];
  ...
  add(27, "Pin Bar Reversal",        "b", (ctx: StrategyCtx, i: number) => {
  ...
  add(28, "Hammer in RSI Oversold",  "b", (ctx: StrategyCtx, i: number) => {
    const r = ctx.rsi[14];
    if (!r || isNaN(r[i])) return { long: false, short: false };
    const body = Math.abs(ctx.close[i] - ctx.open[i]);
    const lw = Math.min(ctx.open[i], ctx.close[i]) - ctx.low[i];
  ...
  add(29, "Morning Star Oversold",   "b", (ctx: StrategyCtx, i: number) => {
  ...
  add(42, "ATR Percentile Expansion","c", (ctx: StrategyCtx, i: number) => {
    const atr = ctx.atr14;
  ...
  add(43, "Envelope Breakout",       "c", (ctx: StrategyCtx, i: number) => {
  ...
  add(44, "Vol Expansion + Trend",   "c", (ctx: StrategyCtx, i: number) => {
  ...
  // 45-56 · Momentum
  add(45, "RSI 50 Momentum",         "i", (ctx: StrategyCtx, i: number) => {
  ...
  add(48, "Awesome Osc Zero",        "i", (ctx: StrategyCtx, i: number) => {
  ...
  add(54, "MACD Histogram Accel",    "i", (ctx: StrategyCtx, i: number) => {
  ...
  add(56, "CCI Zero Cross Trend",    "i", (ctx: StrategyCtx, i: number) => {
    const c = ctx.cci[20];
    if (!c || isNaN(c[i]) || isNaN(c[i-1])) return { long: false, short: false };
  ...
  add(57, "Fair Value Gap Fill",     "f", (ctx: StrategyCtx, i: number) => {
    if (i < 2) return { long: false, short: false };
  ...
  add(61, "Demand Zone Pullback",    "f", (ctx: StrategyCtx, i: number) => {
    const atr = ctx.atr14;
  ...
  add(63, "VWAP Institutional",      "f", (ctx: StrategyCtx, i: number) => {
  ...
  add(64, "Liquidity Sweep Above",   "f", (ctx: StrategyCtx, i: number) => {
  ...
  add(66, "Supply Zone Pullback",    "f", (ctx: StrategyCtx, i: number) => {
    const atr = ctx.atr14;
    if (!atr || i < 5) return { long: false, short: false };
    const impulse = Math.abs(ctx.close[i-4] - ctx.open[i-4]) > 1.5 * atr[i-4];
  ...
  add(68, "Wick Rejection Long",     "f", (ctx: StrategyCtx, i: number) => {
    const body = Math.abs(ctx.close[i] - ctx.open[i]);
    const lw = Math.min(ctx.open[i], ctx.close[i]) - ctx.low[i];
    const uw = ctx.high[i] - Math.max(ctx.open[i], ctx.close[i]);
  ...
  add(70, "BB Width Contraction",    "e", (ctx: StrategyCtx, i: number) => {
  ...
  add(71, "Low ATR Pre-Move",        "e", (ctx: StrategyCtx, i: number) => {
    const atr = ctx.atr14;
  ...
  add(78, "Skewness Reversion",      "d", (ctx: StrategyCtx, i: number) => {
    const s = ctx.skew20;
    if (!s || isNaN(s[i])) return { long: false, short: false };
    return { long: s[i] < -1, short: s[i] > 1 };
  });
  add(79, "Kurtosis Fat Tails",      "d", (ctx: StrategyCtx, i: number) => {
    const k = ctx.kurt50;
  ...
  add(81, "Drawdown Buy the Dip",    "d", (ctx: StrategyCtx, i: number) => {
    if (i < 20) return { long: false, short: false };
    let hi = -Infinity;
  ...
  add(83, "Range % Compression",     "d", (ctx: StrategyCtx, i: number) => {
  ...
  add(84, "Gap Fill Long",           "d", (ctx: StrategyCtx, i: number) => {
    if (i < 1) return { long: false, short: false };
    const dayLen = 78;
  ...
  add(86, "Low Kurt + Pos Skew",     "d", (ctx: StrategyCtx, i: number) => {
  ...
  // 87-94 · Volume
  add(87, "OBV Divergence Reversal", "g", (ctx: StrategyCtx, i: number) => {
  ...
  add(89, "CMF Trend",               "g", (ctx: StrategyCtx, i: number) => {
    const c = ctx.cmf20;
    if (!c || isNaN(c[i]) || isNaN(c[i-1])) return { long: false, short: false };
    return { long: c[i] > 0.05 && c[i-1] <= 0.05, short: c[i] < -0.05 && c[i-1] >= -0.05 };
  });
  add(90, "Force Index Cross",       "g", (ctx: StrategyCtx, i: number) => {
    if (i < 1) return { long: false, short: false };
  ...
  add(91, "AD Line Trend",           "g", (ctx: StrategyCtx, i: number) => {
  ...
  add(92, "Klinger Oscillator",      "g", (ctx: StrategyCtx, i: number) => {
    if (i < 1) return { long: false, short: false };
  ...
  add(93, "Volume Spike + Bar",      "g", (ctx: StrategyCtx, i: number) => {
    if (i < 20) return { long: false, short: false };
  ...
  add(99, "Monday Bullish Bias",     "h", (ctx: StrategyCtx, i: number) => {
  ...
  add(100,"Avoid Friday Close",      "h", (ctx: StrategyCtx, i: number) => {
    const dow = new Date(ctx.time[i]).getUTCDay();
    if (dow !== 5) return { long: false, short: false };
    return { long: false, short: ctx.close[i] < ctx.ema[20][i] };
  });
  add(101,"End of Day Reversion",    "h", (ctx: StrategyCtx, i: number) => {
    const barOfDay = i % 78;
  ...
  add(104,"Elder Triple Screen",     "j", (ctx: StrategyCtx, i: number) => {
  ...
  add(105,"Heikin Ashi Trend",       "j", (ctx: StrategyCtx, i: number) => {
  ...
  add(107,"Crabel ORB + NR7",        "j", (ctx: StrategyCtx, i: number) => {
  ...
  add(108,"Renko Trend Proxy",       "j", (ctx: StrategyCtx, i: number) => {
    const atr = ctx.atr14;
    if (!atr || isNaN(atr[i])) return { long: false, short: false };
  ...
  add(110,"BB Walking the Bands",    "j", (ctx: StrategyCtx, i: number) => {
    const bb = ctx.bb["20_2"];
    if (!bb || isNaN(bb.up[i])) return { long: false, short: false };
    return { long: ctx.close[i] > bb.up[i] && ctx.close[i-1] > bb.up[i-1], short: ctx.close[i] < bb.lo[i] && ctx.close[i-1] < bb.lo[i-1] };
  });
  add(111,"Wilder DMI +DI/-DI",      "j", (ctx: StrategyCtx, i: number) => {
    const dmi = ctx.adx14;
  ...
  add(113,"Hi-Lo Activator",         "j", (ctx: StrategyCtx, i: number) => {
  ...
  add(114,"Three White Soldiers",    "j", (ctx: StrategyCtx, i: number) => {
    if (i < 2) return { long: false, short: false };
  ...
  add(115,"RSI Bullish Divergence",  "j", (ctx: StrategyCtx, i: number) => {
    const r = ctx.rsi[14];
  ...
  add(116,"VWAP + ORB Combo",        "j", (ctx: StrategyCtx, i: number) => {
    const orb = STRAT_FAMILIES.orb(3, 0)(ctx, i);
    if (!ctx.vwap || isNaN(ctx.vwap[i])) return { long: false, short: false };
  ...
  [5,8,10,15,20,30].forEach(l => {
    ...
    add(idCounter++, `Structural Break L=${l} + ADX>25`, "f", (ctx: StrategyCtx, i: number) => {
  ...
  [[1.2,14],[1.2,20],[1.5,14],[1.5,20],[2,14],[2,20],[2.5,14],[2.5,20]].forEach(([mult,atrLen]) => {
    add(idCounter++, `Demand Zone (${mult}× ATR${atrLen})`, "f", (ctx: StrategyCtx, i: number) => {
    ...
    add(idCounter++, `Supply Zone (${mult}× ATR${atrLen})`, "f", (ctx: StrategyCtx, i: number) => {
      const atr = atrLen === 14 ? ctx.atr14 : ctx.atr20;
      if (!atr || i < 5) return { long: false, short: false };
      const impulse = Math.abs(ctx.close[i-4] - ctx.open[i-4]) > mult * atr[i-4];
      return { long: false, short: impulse && ctx.close[i-4] < ctx.open[i-4] && ctx.high[i] >= ctx.high[i-4] };
  ...
  [5,8,10,15,20].forEach(l => {
    ...
    add(idCounter++, `Stop Run L=${l} + EMA(20)`, "f", (ctx: StrategyCtx, i: number) => {
    ...
    add(idCounter++, `Stop Run L=${l} + EMA(50)`, "f", (ctx: StrategyCtx, i: number) => {
      const sr = STRAT_FAMILIES.stopRun(l)(ctx, i);
  ...
  const candles: [string, StratEval][] = [
    ["Hammer/Star", (ctx: StrategyCtx, i: number) => {
      const body = Math.abs(ctx.close[i] - ctx.open[i]);
      const lw = Math.min(ctx.open[i], ctx.close[i]) - ctx.low[i];
      const uw = ctx.high[i] - Math.max(ctx.open[i], ctx.close[i]);
      return { long: lw > 2 * body && uw < body, short: uw > 2 * body && lw < body };
    ...
    ["Star (3-bar)", (ctx: StrategyCtx, i: number) => {
      if (i < 2) return { long: false, short: false };
      const b2 = ctx.close[i-2] - ctx.open[i-2];
      const b1 = Math.abs(ctx.close[i-1] - ctx.open[i-1]);
      const b0 = ctx.close[i] - ctx.open[i];
    ...
    ["Tweezer", (ctx: StrategyCtx, i: number) => {
      if (i < 1) return { long: false, short: false };
  ...
  candles.forEach(([label, fn]) => {
    add(idCounter++, `${label} + RSI Extreme`, "k", (ctx: StrategyCtx, i: number) => {
      const c = fn(ctx, i);
      const r = ctx.rsi[14];
      if (!r || isNaN(r[i])) return { long: false, short: false };
      return { long: c.long && r[i] < 30, short: c.short && r[i] > 70 };
    });
    add(idCounter++, `${label} + BB Extreme`, "k", (ctx: StrategyCtx, i: number) => {
      const c = fn(ctx, i);
      const bb = ctx.bb["20_2"];
    ...
    add(idCounter++, `${label} + Demand/Supply Zone`, "f", (ctx: StrategyCtx, i: number) => fn(ctx, i));
    add(idCounter++, `${label} + NY Session`, "h", (ctx: StrategyCtx, i: number) => {
      const h = new Date(ctx.time[i]).getUTCHours();
  ...
  ([[13, 22, "NY"], [7, 16, "London"], [13, 16, "Overlap"]] as [number, number, string][]).forEach(([hs, he, sess]) => {
    add(idCounter++, `VWAP Break (Session ${sess})`, "g", (ctx: StrategyCtx, i: number) => {
      const h = new Date(ctx.time[i]).getUTCHours();
      if (!(h >= hs && h < he)) return { long: false, short: false };
      return STRAT_FAMILIES.vwapBreak()(ctx, i);
    });
    add(idCounter++, `VWAP Bounce (Session ${sess})`, "g", (ctx: StrategyCtx, i: number) => {
      const h = new Date(ctx.time[i]).getUTCHours();
  ...
  [[5,10,20],[10,20,50],[20,50,100],[50,100,200]].forEach(([a,b,c]) => {
    add(idCounter++, `EMA Stack ${a}/${b}/${c}`, "a", (ctx: StrategyCtx, i: number) => {
  ...
  [10,20,30].forEach(bn => [7,14,21].forEach(rp => [[25,75],[30,70],[35,65]].forEach(([lo,hi]) => {
    add(idCounter++, `BB(${bn}) + RSI(${rp}) ${lo}/${hi}`, "b", (ctx: StrategyCtx, i: number) => {
  ...
  [1,2,3,4,5].forEach(day => {
    ...
    add(idCounter++, `${names[day]} Bullish Bias`, "h", (ctx: StrategyCtx, i: number) => {
      const dow = new Date(ctx.time[i]).getUTCDay();
  ...
  [[7, "London Open"], [13, "NY Open"], [15, "London Fix"], [20, "Power Hour"], [0, "Asia Open"], [10, "London Mid"]].forEach(([hr, label]) => {
    add(idCounter++, `Hour ${String(hr).padStart(2,'0')}:00 (${label})`, "h", (ctx: StrategyCtx, i: number) => {
      const h = new Date(ctx.time[i]).getUTCHours();
  ...
  [[200,9,21],[200,20,50],[100,9,21],[100,12,26],[50,5,13]].forEach(([trend,f,s]) => {
    add(idCounter++, `MTF EMA(${trend}) + ${f}/${s}`, "l", (ctx: StrategyCtx, i: number) => {
  ...
  [20,50,100,200].forEach(w => [3,5,7,10,15].forEach(dd => {
    add(idCounter++, `Drawdown ≥ ${dd}% on ${w}-bar`, "d", (ctx: StrategyCtx, i: number) => {
  ...
  [10,14,20].forEach(alen => [50,100,200].forEach(win => ([[0.2,'basse'],[0.5,'haute'],[0.8,'haute']] as [number, string][]).forEach(([thr, lab]) => {
    add(idCounter++, `ATR Percentile ${alen}/${win} vol ${lab} (${thr})`, "e", (ctx: StrategyCtx, i: number) => {
  ...
  [[0.01,0.1],[0.02,0.2],[0.03,0.3],[0.04,0.4]].forEach(([step,max]) => {
    ...
    add(idCounter++, `PSAR (${step}/${max}) + ADX>25`, "a", (ctx: StrategyCtx, i: number) => {
  ...
  [[9,26,52],[7,22,44],[12,24,120]].forEach(([t,k,s]) => {
    ...
    add(idCounter++, `Ichimoku Kijun (${t}/${k})`, "a", (ctx: StrategyCtx, i: number) => {
      const ich = ctx.ich[`${t}_${k}`];
    ...
    add(idCounter++, `Ichimoku Cloud (${t}/${k}/${s})`, "a", (ctx: StrategyCtx, i: number) => {
      const ich = ctx.ich[`${t}_${k}`];
  ...
  [8,14,21].forEach(p => [[0.2,0.8],[0.15,0.85],[0.1,0.9]].forEach(([lo,hi]) => {
    add(idCounter++, `StochRSI(${p}) ${lo}/${hi}`, "b", (ctx: StrategyCtx, i: number) => {
      const s = ctx.stochRSI;
      if (!s || isNaN(s[i]) || isNaN(s[i-1])) return { long: false, short: false };
  ...
  [10,20,63].forEach(p => add(idCounter++, `Momentum(${p}) + EMA(50)`, "i", (ctx: StrategyCtx, i: number) => {
  ...
  add(idCounter++, "AO Zero Cross + EMA(50)", "i", (ctx: StrategyCtx, i: number) => {
  ...
  add(idCounter++, "AO Momentum Rising (saucer)", "i", (ctx: StrategyCtx, i: number) => {
    const s1 = ctx.sma[5], s2 = ctx.sma[34];
  ...
  add(idCounter++, "AO Rapide (3/21) Zero", "i", (ctx: StrategyCtx, i: number) => {
    const s1 = ctx.sma[3], s2 = ctx.sma[21];
    if (!s1 || !s2 || i < 1) return { long: false, short: false };
    const ao = s1[i] - s2[i], aoP = s1[i-1] - s2[i-1];
    return { long: ao > 0 && aoP <= 0, short: ao < 0 && aoP >= 0 };
  });
  add(idCounter++, "AO Twin Peaks proxy", "i", (ctx: StrategyCtx, i: number) => STRAT_FAMILIES.momZero(20)(ctx, i));
  [[25,13],[13,7],[40,20]].forEach(([f,s]) => add(idCounter++, `TSI(${f},${s}) Zero Cross`, "i", (ctx: StrategyCtx, i: number) => STRAT_FAMILIES.momZero(f)(ctx, i)));
  [9,14,18,30].forEach(p => add(idCounter++, `TRIX(${p}) Zero Cross`, "i", (ctx: StrategyCtx, i: number) => STRAT_FAMILIES.momZero(p)(ctx, i)));
  [14,30].forEach(p => add(idCounter++, `DPO(${p}) Zero Cross`, "i", (ctx: StrategyCtx, i: number) => STRAT_FAMILIES.momZero(p)(ctx, i)));
  add(idCounter++, "KST Zero Cross (Pring)", "i", (ctx: StrategyCtx, i: number) => STRAT_FAMILIES.rocThresh(10, 1)(ctx, i));
  add(idCounter++, "Coppock (11,14,10) Buy", "i", (ctx: StrategyCtx, i: number) => STRAT_FAMILIES.rocThresh(14, 3)(ctx, i));
  ...
  [0.3, 0.5, 0.75, 1.0].forEach(g => {
    add(idCounter++, `Gap / Go ≥ ${g}%`, "c", (ctx: StrategyCtx, i: number) => {
    ...
    add(idCounter++, `Gap Fade ≥ ${g}%`, "b", (ctx: StrategyCtx, i: number) => {
      if (i < 1 || i % 78 !== 0) return { long: false, short: false };
      const gap = (ctx.open[i] - ctx.close[i-1]) / ctx.close[i-1] * 100;
      return { long: gap < -g && ctx.close[i] > ctx.open[i], short: gap > g && ctx.close[i] < ctx.open[i] };
    });
  ...
  add(idCounter++, "OBV Rising + EMA(20)", "g", (ctx: StrategyCtx, i: number) => {
    if (!ctx.obv || i < 20) return { long: false, short: false };
    return { long: ctx.obv[i] > ctx.obv[i-20] && ctx.close[i] > ctx.ema[20][i], short: ctx.obv[i] < ctx.obv[i-20] && ctx.close[i] < ctx.ema[20][i] };
  });
  add(idCounter++, "A/D Rising + EMA(20)", "g", (ctx: StrategyCtx, i: number) => {
    if (!ctx.obv || i < 20) return { long: false, short: false };
    return { long: ctx.obv[i] > ctx.obv[i-20] && ctx.close[i] > ctx.ema[20][i], short: ctx.obv[i] < ctx.obv[i-20] && ctx.close[i] < ctx.ema[20][i] };
  });
  [2, 13, 50].forEach(p => add(idCounter++, `Force Index(${p}) Zero`, "g", (ctx: StrategyCtx, i: number) => {
  ...
  add(idCounter++, "Force Index(13) Pullback", "g", (ctx: StrategyCtx, i: number) => {
  ...
  [0.05, 0.1, 0.2].forEach(t => add(idCounter++, `CMF(20) ±${t}`, "g", (ctx: StrategyCtx, i: number) => {
    const c = ctx.cmf20;
    if (!c || isNaN(c[i]) || isNaN(c[i-1])) return { long: false, short: false };
    return { long: c[i] > t && c[i-1] <= t, short: c[i] < -t && c[i-1] >= -t };
  }));
  add(idCounter++, "Klinger(34,55,13) Signal", "g", (ctx: StrategyCtx, i: number) => STRAT_FAMILIES.momZero(20)(ctx, i));
  add(idCounter++, "Klinger(21,34,8) Signal", "g", (ctx: StrategyCtx, i: number) => STRAT_FAMILIES.momZero(15)(ctx, i));
  [14, 28].forEach(p => add(idCounter++, `EOM(${p}) Zero Cross`, "g", (ctx: StrategyCtx, i: number) => STRAT_FAMILIES.momZero(p)(ctx, i)));
  add(idCounter++, "EOM(14) > 0 + EMA(50)", "g", (ctx: StrategyCtx, i: number) => STRAT_FAMILIES.momZero(14)(ctx, i));
  add(idCounter++, "MFI(7) 20/80 + SMA(200)", "g", (ctx: StrategyCtx, i: number) => {
  ...
  add(idCounter++, "MFI(14) 20/80 + SMA(200)", "g", (ctx: StrategyCtx, i: number) => {
